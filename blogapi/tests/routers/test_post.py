...
from blogapi.core.security import create_access_token
from blogapi.tests.helpers import create_comment, create_post


@pytest.fixture()
def mock_generate_cute_creature_api(mocker):
    return mocker.patch(
        "blogapi.service_tasks.tasks._generate_cute_creature_api",
